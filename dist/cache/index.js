...
export async function initAll() {
    ...
    if (isNaN(Number(maxQ)) || Number(maxQ) <= 0)
        console.warn('CACHE_L2_WRITE_QUEUE_MAX is invalid');
}
...
export function delCache(key) { L1.l1Del(key); void P.pDel(key); void L2.l2Del(key); }
